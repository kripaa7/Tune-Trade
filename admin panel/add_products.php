<?php
        ...
        if (isset($_POST['publish'])) {
            ...
            if ($select_image->rowCount() > 0 AND $image != '') {
                $warning_msg[] = 'please change your image';
            }else{
        ...
        <div class="main-container">
            ...
            <section class="post-editor">
                ...
                <form action="" method="post" enctype="multipart/form-data" class="register">
                    ...
                    <div class="flex-btn">
                        <input type="submit" value="add product" name="publish" class="btn">
                        <input type="submit" value="save as draft" name="draft" class="btn">
                    </div>
                </form>
                </div>
